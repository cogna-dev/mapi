...
`generate` treats `--project` as an existing MoonBit package root: it reads the package name from `moon.mod.json`, regenerates `src/generated/*`, and leaves your existing module manifest untouched.
